...
class VendorVariantValueController extends Controller
{
    ...
    public function index(ProductVariant $variant, Request $request): View
    {
        ...
        return view('Vendor.pages.variants.values.index', compact('variant', 'values', 'variants', 'search'));
    }
    ...
    public function create(ProductVariant $variant): View
    {
        ...
        return view('Vendor.pages.variants.values.create', compact('variant', 'variants'));
    }
    ...
    public function store(VariantValueRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('vendor.variant-values.index', $variantId)
    ...
    public function destroy(ProductVariantValue $value): RedirectResponse
    {
        $value->delete();
        return redirect()
            ->route('vendor.variant-values.index', $value->variant_id)
