...
class VendorProductItemVariantController extends Controller
{
    ...
    public function index(Product $product): View
    {
        ...
        return view('Vendor.pages.products.product_variant_items.index', compact('product', 'items'));
    }
    ...
    public function create(Product $product): View
    {
        ...
        return view('Vendor.pages.products.product_variant_items.create', compact('product', 'variants'));
    }
    ...
    public function store(ProductItemVariantRequest $request, Product $product): RedirectResponse
    {
        ...
        return redirect()
            ->route('vendor.products-variant.index', $product)
    ...
    public function show(Product $product, ProductVariantItem $variantItem): View
    {
        ...
        return view('Vendor.pages.products.product_variant_items.show', [
            'product' => $product,
            'item'    => $variantItem,
        ]);
    }
    ...
    public function edit(Product $product, ProductVariantItem $variantItem): View
    {
        ...
        return view(
            'Vendor.pages.products.product_variant_items.edit',
