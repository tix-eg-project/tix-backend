...
class UpdateProductRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'prod_features'       => 'nullable|array',
            'prod_features.*'     => 'nullable|array',
            'prod_features.*.ar'  => 'nullable|string',
            'prod_features.*.en'  => 'nullable|string',
            'prod_features_loaded'=> 'nullable',

            'qas'            => 'nullable|array',
            'qas.*'          => 'nullable|array',
            'qas.*.question_ar' => 'nullable|string',
            'qas.*.question_en' => 'nullable|string',
            'qas.*.answer_ar'   => 'nullable|string',
            'qas.*.answer_en'   => 'nullable|string',
            'qas_loaded'     => 'nullable',
