...
class ProductDetailsResource extends JsonResource
{
  ...
  'prod_features'          => $this?->prod_features?->map(fn($f) => $f->name_text ?? $f->name)->all(),
            'qas'               => $this->qas->map(fn($qa) => [
                'question' => $qa->question_text ?? $qa->question,
                'answer'   => $qa->answer_text ?? $qa->answer,
            ])->all(),
