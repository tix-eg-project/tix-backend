        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <form method="GET" action="{{ route('variant-values.index', $variant->id) }}" id="searchForm" class="d-flex" style="gap:10px;">
                        <input
                            type="text"
                            name="search"
                            id="searchInput"
                    ...
                    <div>
                        <a href="{{ route('variant-values.create', $variant->id) }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('variant-values.destroy', $item->id) }}" method="POST" class="d-inline-block">
                                        @csrf @method('DELETE')
                ...
                <a href="{{ route('variants.index') }}" class="btn btn-secondary">{{ __('messages.Back') }}</a>
            </div>
        </div>
    </div>
</div>
