{{-- resources/views/Vendor/pages/damaged/show.blade.php --}}
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <a href="{{ route('vendor.damaged-stocks.index') }}" class="btn btn-outline-secondary">{{ __('messages.back') }}</a>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div style="width:72px;height:72px;" class="rounded overflow-hidden bg-light border">
                        <img src="{{ $img }}" class="w-100 h-100" style="object-fit:cover" alt="" loading="lazy"
                ...
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8">
                        @if($item->returnRequest)
                            <a href="{{ route('vendor.returns.show', $item->returnRequest->id) }}">#{{ $item->returnRequest->id }}</a>
                        @else
                            -
                        @endif
                    </dd>
