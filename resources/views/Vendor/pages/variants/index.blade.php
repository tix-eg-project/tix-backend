        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <!-- Left: Search -->
                    <form method="GET" action="{{ route('vendor.variants.index') }}" id="searchForm" class="d-flex" style="gap: 10px;">
                        <input type="text"
                            name="search"
                            id="searchInput"
                    ...
                    <!-- Right: Add Button -->
                    <div>
                        <a href="{{ route('vendor.variants.create') }}" class="btn btn-primary">
                    ...
                    <table class="table table-striped text-black text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $nameText }}</td>
                                <td>
                                    <a href="{{ route('vendor.variants.edit', $item->id) }}" class="btn btn-sm btn-primary me-1">
                                        <i class="fa-regular fa-pen-to-square"></i>
                                    </a>

                                    <a href="{{ route('vendor.variant-values.create', $item->id) }}"
                                        class="btn btn-sm btn-warning me-1" title="Add Value">
                                        <i class="bi bi-plus-square-dotted"></i>
                                    </a>

                                    <form action="{{ route('vendor.variants.destroy', $item->id) }}" method="POST" class="d-inline-block">
                                        @csrf @method('DELETE')
                ...
                <a href="{{ route('vendor.dashboard') }}" class="btn btn-secondary">{{ __('messages.Back') }}</a>
            </div>
        </div>
    </div>
</div>
